...
//----------------------------
eyes.setRoundEyes(false);          // Отключаем полностью круглый вид
eyes.setWidth(40, 40);             // Шире глаза — более квадратные
eyes.setHeight(32, 32);            // Чуть ниже высоты для прямоугольности
eyes.setBorderradius(7, 7);      // Скругление углов — мягкий квадрат, как у EMO
eyes.setSpacebetween(10);          // Расстояние между глазами
eyes.setPupilsEnabled(true);       // Зрачки включены
eyes.setAutoblinker(true, 4, 5);    // Естественное моргание
eyes.setPupilSize(7);               // Размер зрачков
